...
useEffect(()=>{
   ...
   sortProduct();
    ...
    return (
        <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 borde-tr'>
           {/*Filter option*/}

        <div className='min-w-60'>
          <p onClick={()=>setShowFilter(!showFilter)} className='my-2 text-xl items-center cursor-pointer gap-2'>FILTERS
            <img className={`h-3 sm:hidden bg-gray-600  ${showFilter? "rotate-90": ''}`}src={assets.dropdown_icon} alt="" /> </p>
          {/* Category filters*/}
